...
const App = () => {
	...
	const [userListPerPage, SetPostsPerPage] = useState(10);
	...
	const indexOfLastPost = currentPage * userListPerPage;
	const indexofFirstUselList = indexOfLastPost - userListPerPage;
	const currentPosts = params.userList.slice(indexofFirstUselList, indexOfLastUserList);
	...
	return (
		<div className='conteiner'>
			...
			<Pagination
				postsPerPage={userListPerPage}
				totalPosts={params.userList.length}
			/>
		</div>
	);
};
